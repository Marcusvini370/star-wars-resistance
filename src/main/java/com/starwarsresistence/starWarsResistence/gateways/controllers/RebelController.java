...
import com.starwarsresistence.starWarsResistence.gateways.controllers.swagger.RebelControllerSwagger;
...
@AllArgsConstructor
public class RebelController implements RebelControllerSwagger {
    ...
    @GetMapping("{rebelId}")
    @ResponseStatus(HttpStatus.OK)
    public Rebel rebelById(@PathVariable Long rebelId) {
        return listRebels.rebelById(rebelId);
    }
